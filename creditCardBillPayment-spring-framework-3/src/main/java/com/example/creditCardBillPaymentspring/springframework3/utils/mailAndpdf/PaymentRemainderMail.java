...
public class PaymentRemainderMail {
	...
	public static void remainderMail(StatementRemainderDTO dto) {
		...
		String bodymsg = "Dear Customer , " + "<br/>This is to remain you that your payment of " + dto.getTotalDue()
				+ " has been due since " + dto.getDueDate() + "</b>\r\n"
				+ "<br/> and the last date to pay without interest is " + dto.getPayBy()
				+ ". The minimum due amount is " + dto.getMinimumAmountDue() + "</b>\r\n"
				+ "<br/> In case you forgot to make your payment of " + (dto.getTotalDue())
				+ ", here's your reminder.</b>\r\n" + "<br/> Warm Regards</b>\r\n";
